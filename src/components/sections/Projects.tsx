        ...
        <div className="space-y-5">
          {sections.map((section) => {
            ...
            return (
              <div
                key={section.key}
                className="rounded-2xl border border-camel-600/50 bg-khaki-beige-900/60 p-4 dark:border-ebony-600 dark:bg-charcoal-brown-200/80"
              >
                <button
                  type="button"
                  ...
                  className="flex w-full items-center justify-between rounded-xl px-2 py-2 text-left text-lg font-semibold text-dark-walnut-500 transition hover:bg-camel-700/30 dark:text-khaki-beige-900 dark:hover:bg-ebony-500/60"
                >
                ...
                {isOpen ? (
                  <div id={`projects-${section.key}`} className="mt-4 grid gap-5 sm:grid-cols-2">
